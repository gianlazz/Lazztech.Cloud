...
namespace Lazztech.Cloud.ClientFacade.Migrations
{
    ...
    [Migration("20190310010433_AddedEmailAndPasswordFieldToInstagramNode")]
    partial class AddedEmailAndPasswordFieldToInstagramNode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lazztech.Marketing.Dal.Dao.InstagramHashtag", b =>
                {
                    b.Property<int>("InstagramHashtagId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Lazztech.Marketing.Dal.Dao.InstagramPost", b =>
                {
                    b.Property<int>("InstagramPostId")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("Caption");

                    b.Property<DateTime?>("DateTimeForPost");
                    ...
                    b.HasKey("InstagramPostId");

                    b.HasIndex("InstagramNodeId");

                    b.ToTable("InstagramPosts");
                });

            modelBuilder.Entity("Lazztech.Marketing.Dal.Dao.SelectedInstaContent", b =>
                {
                    b.Property<int>("SelectedInstaContentId")
                        .ValueGeneratedOnAdd();

                    b.Property<DateTime>("DateTimeWhenSelected");

                    b.Property<int?>("FocusGroupId");

                    b.Property<string>("LinkToContent");

                    b.HasKey("SelectedInstaContentId");

                    b.HasIndex("FocusGroupId");

                    b.ToTable("SelectedInstaContents");
                });
            ...
            modelBuilder.Entity("Lazztech.Marketing.Dal.Dao.InstagramPost", b =>
                {
                    b.HasOne("Lazztech.Marketing.Dal.Dao.InstagramNode", "InstagramNode")
                        .WithMany("InstagramPosts")
                        .HasForeignKey("InstagramNodeId");
                });

            modelBuilder.Entity("Lazztech.Marketing.Dal.Dao.SelectedInstaContent", b =>
                {
                    b.HasOne("Lazztech.Marketing.Dal.Dao.FocusGroup")
                        .WithMany("SelectedInstaContents")
                        .HasForeignKey("FocusGroupId");
                });
