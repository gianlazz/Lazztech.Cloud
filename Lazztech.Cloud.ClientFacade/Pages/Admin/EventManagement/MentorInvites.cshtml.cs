...
namespace Lazztech.Cloud.ClientFacade.Pages.Admin.EventManagement
{
    public class MentorInvitesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (NewInvite.PhoneNumber != null)
                _sms.SendSms(NewInvite.PhoneNumber, $"You've been invited to mentor at " +
                    $"{NewInvite.Event.Organization.Name}'s {NewInvite.Event.Name} event!" +
